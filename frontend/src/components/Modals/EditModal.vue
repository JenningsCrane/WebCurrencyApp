<template>
  <base-modal
    :title="'Изменить выбранный элемент'"
    :modalStatus="editModalStatus"
    @closeModal="toggleModal"
  >
    <!-- EVENTS -->
    <template v-if="editModalStatus === 'events'" v-slot:modal-body>
    ...
    <!-- EMPLOYEE -->
    <template v-if="editModalStatus === 'employee'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
    ...
    <!-- CLIENTS -->
    <template v-if="editModalStatus === 'clients'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
          <label for="title">Введите фамилию</label>
          <input
    ...
    <!-- TARIFFS -->
    <template v-if="editModalStatus === 'tariffs'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
          <label for="title">Название</label>
          <input
    ...
    <!-- SERVICES -->
    <template v-if="editModalStatus === 'services'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
          <label for="title">Название</label>
          <input
    ...
    <!-- BLOG -->
    <template v-if="editModalStatus === 'blog'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
          <label for="title">Название</label>
          <input
    ...
    <!-- LEAGUES -->
    <template v-if="editModalStatus === 'leagues'" v-slot:modal-body>
      <form @submit.prevent="handleSubmit" class="edit-form">
        <div class="modal-section p-4 gap-3">
          <label for="title">Название</label>
          <input
